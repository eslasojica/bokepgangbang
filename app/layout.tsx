...
export const metadata: Metadata = {
    ...
    metadataBase: new URL("https://bokepgangbang.pages.dev"),
    alternates: {
        canonical: `/`,
    },
    openGraph: {
...
export default function RootLayout({
    ...
    const jsonLd = {
        ...
        "name": `${SITENAME}`,
        "description": `${SITENAME} Video Bokep Indo Jepang Jav Barat Simontok Viral Terbaru Bocil Ngentot Jilbab Smp Mama Sma korea china tante live paksa ngentot abg cewek pelajar.`,
        "logo": "https://bokepgangbang.pages.dev/favicon.ico",
        "url": "https://bokepgangbang.pages.dev",
        "founder":{
            "@type":"Person",
            "name":"admin",
            "url":"https://bokepgangbang.pages.dev"
        ...
        "url": "https://bokepgangbang.pages.dev",
        "description": `${SITENAME} Video Bokep Indo Jepang Jav Barat Simontok Viral Terbaru Bocil Ngentot Jilbab Smp Mama Sma korea china tante live paksa ngentot abg cewek pelajar.`,
        "image": "https://bokepgangbang.pages.dev/favicon.ico",
        "potentialAction":{
            "@type":"ReadAction",
            "target":"https://bokepgangbang.pages.dev"}
        }
        const jsonLd2 = {
            "@context": "https://schema.org",
        "@type": "WebSite",
        ...
        "potentialAction": { 
        "@type": "SearchAction", 
          "target": "https://bokepgangbang.pages.dev/?q={search_term}", 
